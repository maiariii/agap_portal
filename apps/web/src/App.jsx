...
const TOUR_STEPS = [
  ...
  { view: "applications", sel: ".action-card", title: "Quick action · Download IER", body: "Exports the Initial Evaluation Result (DepEd Order 7 · Annex D) — an official Excel file (.xlsx) of Qualified and Disqualified applicants for the position." },
