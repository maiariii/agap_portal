        ...
        {currentStep === 1 && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '24px' }}>
            ...
            <div style={{
              ...
              {/* Quick Benchmark Demo Testing Section */}
              <div style={{ borderTop: '1px solid var(--line)', paddingTop: '18px' }}>
                <div style={{
                  ...
                  <span style={{ fontSize: '11px', fontWeight: 800, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                    Verification Test Datasets (Sample Audits)
                  </span>
                  <span style={{ fontSize: '11px', color: 'var(--muted)' }}>
                    One-click audit verification
                  </span>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px' }}>
                  ...
                  >
                    <div style={{ fontWeight: 800, marginBottom: '3px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                      ...
                      Compliant Dataset Sample
                    </div>
                    <div style={{ fontSize: '11px', opacity: 0.85, fontWeight: 500 }}>
                      Passes all scoring rubrics & unfilled item criteria
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div style={{ fontSize: '11px', opacity: 0.85, fontWeight: 500 }}>
                      Tests validation alerts (LET &gt; 25, invalid item codes)
                    </div>
                  </button>
                </div>
              </div>
