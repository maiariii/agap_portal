...
export const documentAuditLogs = pgTable("document_audit_logs", {
	...
	batchNumber: varchar("batch_number", { length: 100 }).default('1'::character varying),
});
...
export const reclassificationApplications = pgTable("reclassification_applications", {
	...
	evaluationStatus: varchar("evaluation_status", { length: 50 }).default('pending_reevaluation'::character varying),
...
export const carUploadBatches = pgTable("car_upload_batches", {
	...
	status: varchar("status", { length: 50 }).default('processing'::character varying).notNull(),
...
export const teacherItems = pgTable("teacher_items", {
	...
	division: varchar("division", { length: 255 }).notNull(),
	positionTitle: varchar("position_title", { length: 100 }).default('Teacher I'::character varying),
...
export const carResults = pgTable("car_results", {
	...
	validationStatus: varchar("validation_status", { length: 20 }).default('valid'::character varying).notNull(),
...
export const applicants = pgTable("applicants", {
	...
	sex: varchar("sex", { length: 20 }),
	civilStatus: varchar("civil_status", { length: 50 }),
	citizenship: varchar("citizenship", { length: 100 }).default('Filipino'::character varying),
	bloodType: varchar("blood_type", { length: 10 }),
	gsisIdNo: varchar("gsis_id_no", { length: 50 }),
	pagIbigIdNo: varchar("pag_ibig_id_no", { length: 50 }),
	philhealthNo: varchar("philhealth_no", { length: 50 }),
...
export const vacancies = pgTable("vacancies", {
	...
	fillingUpStatus: varchar("filling_up_status", { length: 50 }).default('UNFILLED'::character varying).notNull(),
